...
def _wrap_function(sc, func, returnType):
    ...
    return sc._jvm.PythonFunction(bytearray(pickled_command), sc.environment, sc._python_includes, sc._conda_packages,
                                  sc.pythonExec, sc.pythonVer, broadcast_vars, sc._javaAccumulator)
